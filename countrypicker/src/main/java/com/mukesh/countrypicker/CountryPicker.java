...
//      new Country("BE", "Belgium", "+32", R.drawable.flag_be, "EUR"),
            ...
            new Country(/*"NL"*/"ND", "Netherlands", "+31", R.drawable.flag_nl, "EUR"),
    ...
    private static Country[] customCountryList = null;
    ...
    CountryPicker(Builder builder) {
        ...
        if (customCountryList == null) countries = new ArrayList<>(Arrays.asList(COUNTRIES));
        else countries = new ArrayList<>(Arrays.asList(customCountryList));
    ...
    public static class Builder {
        ...
        public Builder setCountryList(final Country[] countryList) {
