...
import com.mobile.praaktishockey.ui.timeline.adapter.TimelinePagerAdapter
...
class TimelineFragment constructor(override val layoutId: Int = R.layout.fragment_timeline2) : BaseFragment() {
    ...
    private fun initPager() {
        ...
        with(vpTimeline) {
            ...
            for (i in 0..tlTimeline.tabCount) {
                ...
                val tvItemTxt = tab?.customView?.findViewById<AppCompatTextView>(R.id.tvTimelineItem)
