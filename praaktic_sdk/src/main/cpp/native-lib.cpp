...
Java_com_praaktis_exerciseengine_Engine_ExerciseEngineActivity_yuvToRGBGrayscale(JNIEnv *env, jobject thiz,
                                                                          jbyteArray buf,
                                                                          jintArray pixels,
                                                                          jint n) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_praaktis_exerciseengine_Engine_ExerciseEngineActivity_yuvToRGB(JNIEnv *env, jobject thiz,
                                                                 jbyteArray bytes_y,
                                                                 jbyteArray bytes_b,
                                                                 jbyteArray bytes_r,
                                                                 jobject bmp,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_praaktis_exerciseengine_Engine_ExerciseEngineActivity_yuvPlanarToRGB(JNIEnv *env, jobject thiz,
                                                                       jbyteArray bytes_y,
                                                                       jbyteArray bytes_b,
                                                                       jbyteArray bytes_r,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_praaktis_exerciseengine_Engine_ExerciseEngineActivity_resizeYUV3(JNIEnv *env, jobject thiz,
                                                                   jbyteArray out_arr,
                                                                   jbyteArray bytes_y,
                                                                   jbyteArray bytes_b,
                                                                   jbyteArray bytes_r,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_praaktis_exerciseengine_RawPlayer_H264RawPlayerActivity_yuvToRgb(JNIEnv *env, jobject thiz,
                                                                          jbyteArray bytes_y,
                                                                          jbyteArray bytes_b,
                                                                          jbyteArray bytes_r,
                                                                          jobject bmp,
