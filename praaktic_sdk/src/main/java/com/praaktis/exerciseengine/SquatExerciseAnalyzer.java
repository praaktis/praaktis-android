...
public class SquatExerciseAnalyzer extends ExerciseAnalyser {
    ...
    private float mMeanS1 = 0;
    private float mMeanS2 = 0;
    private float mMeanS = 0;
    int count = 0;
    ...
    public void loadScores() {
        synchronized (Globals.EXERCISE_SCORES){
            int n = mS.size();
            Globals.EXERCISE_SCORES.put("meanS1", ((Float) mMeanS1) / n);
            Globals.EXERCISE_SCORES.put("meanS2", ((Float) mMeanS2) / n);
            Globals.EXERCISE_SCORES.put("meanS",   ((Float) mMeanS) / n);
